 ...
 def busqueda_amplitud(self,estado_inicial,solucion):
    ...
    while((not solucionado) and (len(nodos_pendientes)!=0)):
        ...
        if(nodo.get_datos()==solucion):
            ...
            hijo=[dato_nodo[1],dato_nodo[2],dato_nodo[0],dato_nodo[3],dato_nodo[4],dato_nodo[5]]
            hijo_izq=Nodo(hijo)
            ...
            hijo=[dato_nodo[0],dato_nodo[1],dato_nodo[2],dato_nodo[4],dato_nodo[5],dato_nodo[3]]
